...
./shasta-Linux-0.11.1 --input ../../basecalled_data/HG002_R9G6FAST_q8.fastq --config Nanopore-Sep2020 --threads 128 --assemblyDirectory ../results/R9G6FAST_R9G4;

## correct config
./shasta-Linux-0.11.1 --input ../../basecalled_data/HG002_R9G6FAST_q8.fastq --config Nanopore-May2022 --threads 128 --assemblyDirectory ../results/R9G6FAST_R9G6;

## wrong config to R10
./shasta-Linux-0.11.1 --input ../../basecalled_data/HG002_R9G6FAST_q8.fastq --config Nanopore-R10-Fast-Nov2022 --threads 128 --assemblyDirectory ../results/R9G6FAST_R10;
