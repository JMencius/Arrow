...
conda activate yak;
yak qv -t 32 -p -K 3.2g -l 100k ../../yak/results/sr.yak ../results/R9G6SUP_R10/Assembly.fasta > ../results/R9G6SUP_R10/yak.txt;
yak qv -t 32 -p -K 3.2g -l 100k ../../yak/results/sr.yak ../results/R9G6SUP_R9G4/Assembly.fasta > ../results/R9G6SUP_R9G4/yak.txt;
yak qv -t 32 -p -K 3.2g -l 100k ../../yak/results/sr.yak ../results/R9G6SUP_R9G6/Assembly.fasta > ../results/R9G6SUP_R9G6/yak.txt;
